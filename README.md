...
3. Configure with your iRedMail edition (MySQL/MariaDB or PgSQL), and the `vmail` database password iRedMail generated for you. You can find it in iRedMail.tips in iRedAdmin's root directory (`/opt/www/iredadmin` on Debian).
